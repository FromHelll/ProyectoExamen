...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h1 class="style4"><strong>MEDICOS</strong></h1>
    <hr />
    ...
    <table class="style1">
        <tr>
            ...
            <td class="style3">
                ...
                <asp:SqlDataSource ID="SqlDataSourceTipIdent" runat="server" 
                    ...
                    SelectCommand="SELECT [IdTipoIdentificacion], [NombreTipo] FROM [TipoIdentificacion]">
                </asp:SqlDataSource>
            </td>
            <td>
        ...
        <tr>
            ...
            <td style="font-style: italic">
                Para Consultar Un Medico Solo Ingrese Su identificacion <em>y luego clic al 
        ...
        <tr>
            ...
            <td class="style3">
                ...
                <asp:SqlDataSource ID="SqlDataSourceTipoEspecialidad" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:DBCITASConnectionString %>" 
                    SelectCommand="SELECT [IdEspecialidades], [NombreEspecialidad] FROM [Especialidades]">
                </asp:SqlDataSource>
            </td>
            <td>
                &nbsp;</td>
        ...
        <tr>
            ...
            <td class="style3">
                ...
                <asp:SqlDataSource ID="SqlDataSourceJornada" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:DBCITASConnectionString %>" 
                    SelectCommand="SELECT [IdHorario], [Jornada] FROM [Horarios]">
                </asp:SqlDataSource>
            </td>
            <td>
                &nbsp;</td>
